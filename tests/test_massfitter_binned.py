...
SGNPDFSDPLUS = ["gaussian", "doublegaus", "crystalball", "doublecb"]
...
for bkg_pdf in BKGPDFSDPLUS:
    for sgn_pdf in SGNPDFSDPLUS:
        ...
        if bkg_pdf == "chebpol1":
            FITTERBINNEDDPLUS[-1].set_background_initpar(0, "c0", 850)
            FITTERBINNEDDPLUS[-1].set_background_initpar(0, "c1", -0.4)
